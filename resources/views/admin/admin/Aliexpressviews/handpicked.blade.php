            ...
            <div class="box-body">
              ...
              @endif
                  ...
                  <?php $i = 0; ?>
                        ...
                        <td>{{$value->price}}</td>
                        <td>{{$value->orders}}</td>
                        <td>{{$value->estimated_monthly_sales}}</td>
                        <td>{{$value->estimated_monthly_revenue}}</td>
                        <td class="action_links">
                          <a href ="{{url('admin/category-edit')}}/{{$value->maincategory_id}}/{{$value->id}}" title="Edit"><i class="fa fa-pencil"></i></a>
                          <a href ="{{url('admin/category_delete')}}/{{$value->id}}"  onclick="return confirm('Are you sure!')" title="Delete"><i class="fa fa-trash-o"></i></a>
                        </td>
  								  </tr>
                  @empty
                    <tr>
